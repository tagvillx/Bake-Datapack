# setup string flattening processor
    ...
    setblock ~ ~ ~3 chain_command_block[facing=east]{auto:1b,TrackOutput:1b,UpdateLastExecution:0b,Command:"execute as 6733-7c1a-49e6-ae5b-844a run function general:_gcm_/flattener/slicer/concat_length"}
    ...
    setblock ~1 ~ ~2 chain_command_block[facing=north]{auto:1b,TrackOutput:1b,UpdateLastExecution:0b,Command:"function general:_gcm_/flattener/slicer/generate"}
