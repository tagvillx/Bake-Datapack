...
# 檢查通過時，施放
execute if score $cd_ok knowledge matches 1 if score @s knowledge.end_fire matches 1.. run function knowledge:end_fire_ball/cast
execute if score $cd_ok knowledge matches 1 unless score @s knowledge.end_fire matches 1.. run function knowledge:fire_ball/cast
