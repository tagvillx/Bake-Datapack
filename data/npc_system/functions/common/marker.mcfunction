...
data modify entity @s data.Quest set from storage npc_system:dialogue This.Dialogue.Quest
data modify entity @s data.Command set from storage npc_system:dialogue This.Dialogue.Command
