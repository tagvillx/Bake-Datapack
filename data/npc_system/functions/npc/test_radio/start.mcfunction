...
# execute if score $<quest_ID> quest.state matches 1 unless data storage npc_system:dialogue This.Dialogue run data modify storage npc_system:dialogue This.Dialogue set from storage quest:dialogue <quest_ID>.<stage>
...
execute if score $demo.mysterious_stone quest.state matches 3 unless data storage npc_system:dialogue This.Dialogue run function npc_system:npc/test_radio/check_stone
