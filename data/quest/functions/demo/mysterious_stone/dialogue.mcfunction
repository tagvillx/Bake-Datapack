# 階段為1時，由 "test_radio" 觸發，選擇選項1後將階段設為2
...
# 階段為2時，由 "test_endsky" 觸發，結束後將階段設為3，並給予道具
...
# 階段為3且玩家持有指定道具時，由 "test_radio" 觸發，結束後將階段設為4，收走指定道具，並給予另外的道具
data modify storage quest:dialogue demo.mysterious_stone.Got set value {Texts:['{"text":"看來你拿到神奇石頭了"}','{"text":"太感謝你了"}','{"text":"雖然算不上什麼謝禮"}','{"text":"不過還請你收下這個吧"}'],Command:"function quest:demo/mysterious_stone/finish"}

# 階段為3且玩家無持有指定道具時，由 "test_radio" 觸發，選擇選項2後將階段設為0
