...
execute as @a[scores={trident_copy_droup=1..}] at @s as @e[type=item,sort=nearest,distance=..4,predicate=sanctuary_ench:trident_copy/semireal] at @s run function sanctuary_ench:trident_copy/semireal_dropped
